...
public abstract class ObjectGenerator<T> {
  ...
  public String askString(String prompt, Predicate<String> validator, boolean fileMode)
  ...
  public Enum askEnum(
      String prompt, Enum[] exceptedValues, Predicate<String> validator, boolean fileMode)
      throws ObjectCreationException {
    if (fileMode) {
      prompt = "";
    } else {
  ...
  public Integer askInteger(String prompt, Predicate<Integer> validator, boolean fileMode)
      throws ObjectCreationException {
    if (fileMode) {
      prompt = "";
    }
  ...
  public Long askLong(String prompt, Predicate<Long> validator, boolean fileMode)
      throws ObjectCreationException {
    if (fileMode) {
      prompt = "";
    }
  ...
  public Double askDouble(String prompt, Predicate<Double> validator, boolean fileMode)
      throws ObjectCreationException {
    if (fileMode) {
      prompt = "";
    }
  ...
  public Float askFloat(String prompt, Predicate<Float> validator, boolean fileMode)
      throws ObjectCreationException {
    if (fileMode) {
      prompt = "";
    }
